...
def getHistory(current_version, openid):
    # 青春山东每一次更新都会使得url发生变化，需要开发者定期维护
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML,"
                      "like Gecko) Mobile/15E148 MicroMessenger/8.0.37(0x1800252f) NetType/4G"
                      "Language/zh_CN",
        "Connection": "keep-alive",
        "Referer": "http://qndxx.youth54.cn/SmartLA/dxx.w?method=enterIndexPage&fxopenid=&fxversion=",
        "Host": "qndxx.youth54.cn",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh-Hans;q=0.9,en-CN;q=0.8,en-US;q=0.7,en;q=0.6",
        "Content-Length": "35",
...
def passInfo():
    ...
    headers = {
        ...
        "X-Requested-With": "XMLHttpRequest",
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML,"
                      "like Gecko) Mobile/15E148 MicroMessenger/8.0.37(0x1800252f) NetType/4G Language/zh_CN",
        "Referer": "http://qndxx.youth54.cn/SmartLA/dxx.w?method=enterIndexPage&fxopenid=&fxversion=",
        "Connection": "close",
